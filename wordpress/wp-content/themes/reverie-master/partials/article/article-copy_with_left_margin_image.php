...
?>
    ...
    <div data-embed="<?php echo $embed_code; ?>" class="row article-copy-with-left-margin-image article-component small-collapse <?php if($has_video) { echo ' js-article-inline-video'; } ?>">
        ...
        <div class='article-left-margin-image-with-play-button <?php if($has_video) { echo 'js-iframe-target margin-video'; } ?>' style='position: relative; margin-top:9px;' >
            ...
            <div class='article-left-margin-caption-and-cta columns small-8 small-centered' style="display: none;">
        ...
        <div class='article-left-margin-image-copy large-uncentered medium-uncentered small-centered columns medium-4 large-5 small-8'>
            <?php echo $content ?>
        </div>
    </div>
